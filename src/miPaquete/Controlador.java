...
public class Controlador {
    ...
    public static servicioClase buscarServicio(int codigoBuscado){
    ...
    public static boolean verficarCodigo(int idDeServicio){
        for (servicioClase servicio : serviciosArray) {
